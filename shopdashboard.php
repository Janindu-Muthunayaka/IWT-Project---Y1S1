...
<body>
    ...
    <div class="bg">
    <div id="countdown" style="font-size: 20px; color: white; margin: 80px 0 1px 10px;"></div>
    <script>
        function updateCountdown() {
            const countdownElement = document.getElementById("countdown");
            const targetDate = new Date('2023-10-23 00:00:00');
            const now = new Date();
            const timeRemaining = targetDate - now;
            const days = Math.floor(timeRemaining / (1000 * 60 * 60 * 24));
            const hours = Math.floor((timeRemaining % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));
            countdownElement.textContent = `Till next Shipment - Days: ${days}, Hours: ${hours}`;
        }
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><a href="updateproduct.php?AdminPassword=<?php echo $AdminPassword; ?>&AdminName=<?php echo $AdminName; ?>&ProductId=<?php echo $row["ProductId"]; ?>">Update product</a></td>
                        </tr>
                    <?php
                    }
                    ?>
